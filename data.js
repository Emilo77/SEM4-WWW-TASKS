let array = [
    {
        ...
        image: 'gory.jpg',
        title: 'Wysokie Góry',
        title_2: 'Niezwykle strome',
        body: 'Krótka wycieczka na ten właśnie szczyt. Niezwykle  ciekawe atrakcje.',
        price: '15002900',

        long_descripion: 'Po kawce w Gościńcu Równica mieliśmy znów sporo energii aby pokonywać kolejne kilometry.' +
...

    {
        ...
        image: 'morza.jpg',
        title: 'Dalekie morza',
        title_2: 'Niezwykle dalekie',
        body: 'Mórz jest wiele, więc i opis może być nieco dłuższy niż poprzednio. Atrakcji może być więcej.',
        price: '17',

        long_descripion:
            'Basowy huk fal, stada rozkrzyczanych mew szybujących nad wypływającym w morze statkiem, ' +
...

    {
        ...
        image: 'mediolan.jpg',
        title: 'Mediolan',
        title_2: 'JESTEŚMY W MEDIOLANIEEE',
        body: 'Ciuszki i super exclusive rzeczy w przystępnych cenach. Raj dla fanów mody',
        price: '2193123',

        long_descripion:
            'Weekend w Mediolanie? W czasie pandemii? To mocno przewrotne i zdecydowanie w naszym stylu. ' +
